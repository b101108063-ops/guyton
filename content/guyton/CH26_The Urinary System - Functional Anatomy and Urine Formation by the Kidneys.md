...
book: "Guyton & Hall"
summary: "This chapter provides an overview of the kidney's multiple homeostatic functions beyond waste excretion, including regulation of fluid balance, electrolyte composition, arterial pressure, acid-base balance, erythrocyte production, vitamin D activation, and gluconeogenesis. It describes the gross and microscopic anatomy of the kidneys and introduces the three fundamental renal processes: glomerular filtration, tubular reabsorption, and tubular secretion, which together determine urinary excretion rates."
key_points:
  - "The kidneys filter ~180 L/day of plasma at the glomerulus, reabsorbing ~99% of the filtrate, while excreting only ~1-2 L as urine; this allows precise regulation of body fluid composition"
  - "Urinary excretion rate = Glomerular filtration rate − Tubular reabsorption rate + Tubular secretion rate; reabsorption is quantitatively more important than secretion for most substances"
  - "The kidneys regulate arterial pressure by controlling sodium and water excretion, produce erythropoietin to stimulate red blood cell production, and synthesize calcitriol (1,25-dihydroxyvitamin D3) for calcium homeostasis"
  - "The renal cortex contains the glomeruli and convoluted tubules, while the medulla contains the loops of Henle and collecting ducts; countercurrent multiplication in the medulla creates the medullary osmotic gradient for urine concentration"
  - "Substances handled differently by the kidney: (1) only filtered and excreted like creatinine, (2) filtered and partly reabsorbed like sodium, (3) completely reabsorbed like glucose, or (4) filtered and secreted like organic acids and bases"
---
...
The kidneys serve many important homeostatic functions, including:
...
If the kidney is bisected from top to bottom, two major regions can be visualized:
...
1. **Glomerular filtration**: of substances in the blood
...
The urinary excretion rate is calculated as:
...
| Process | Description |
|---------|-------------|
| Glomerular filtration | Blood pressure forces fluid and solutes through glomerular capillaries into Bowman's capsule |
| Tubular reabsorption | Selected substances move from tubule lumen through tubular cells into peritubular capillaries |
| Tubular secretion | Selected substances move from peritubular capillaries into tubular lumen |
