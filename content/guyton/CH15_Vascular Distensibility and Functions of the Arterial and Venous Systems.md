...
key_points:
  - "Vascular distensibility = (increase in volume)/(original volume × increase in pressure); a vein is ~8× more distensible than a comparable artery"
  - "Venous compliance is ~24× greater than arterial compliance because veins are both more distensible and have ~3× greater volume"
  - "Pulse pressure = systolic − diastolic pressure and is determined primarily by stroke volume and arterial compliance; decreased arterial compliance (as in aging) increases pulse pressure"
...
Blood flows through the liver from two sources:

- **Portal vein**: delivers about **1050 ml/min**
- **Hepatic artery**: delivers about **300 ml/min**
- **Total**: about **1350 ml/min**, which is **27%** of the resting cardiac output
...
When liver parenchymal cells are destroyed, they are replaced with fibrous tissue that eventually contracts around the blood vessels. This greatly impedes the flow of portal blood through the liver — a disease process known as **cirrhosis of the liver**.
...
| Infectious processes | Infections in the bile ducts |

### Portal Vein Obstruction

The portal system can also be occasionally blocked by a large clot developing in the portal vein or its major branches.
...
Blockage of portal flow through the liver also causes high capillary pressures in the entire portal vascular system of the gastrointestinal tract. This results in:

- **Edema of the gut wall**
- **Transudation of fluid** through the serosa of the gut into the abdominal cavity
- **Ascites**
...
This regeneration is remarkably rapid, requiring only **5 to 7 days** in rats. During liver regeneration, hepatocytes are estimated to replicate once or twice. After the original size and volume of the liver are achieved, the hepatocytes revert to their usual quiescent state.
...
- Produced by **mesenchymal cells** in the liver and in other tissues — **not by hepatocytes**
- Blood levels of HGF rise more than **20-fold** after partial hepatectomy
- Mitogenic responses are usually found only in the liver after these operations, suggesting HGF may be activated only in the affected organ

### Other Factors in Regeneration

Other growth factors and cytokines involved in stimulating regeneration include:
...
> **Figure 71-1.** Basic structure of a liver lobule, showing the liver cellular plates, the blood vessels, the bile-collecting system, and the lymph flow system composed of the spaces of Disse and the interlobular lymphatics.

Key structural components:

| Component | Description |
|-----------|-------------|
| Liver cell plate | Organization of hepatocytes |
| Sinusoids | Blood-filled spaces between liver cell plates |
| Space of Disse | Perisinusal space where lymph forms |
| Portal vein | Supplies portal blood to sinusoids |
| Hepatic artery | Supplies oxygenated blood |
| Central vein | Collects blood from sinusoids |
| Bile canaliculi | Collect bile from hepatocytes |
| Kupffer cells | Macrophages lining sinusoids |
| Lymphatic duct | Drains lymph from liver |
