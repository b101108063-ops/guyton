...
book: "Guyton & Hall"
summary: "Chapter 8 from Guyton & Hall Textbook of Medical Physiology, 14th Edition. Content extracted from official PDF source."
key_points:
...
cle—that is, their attachment to actin, then release from 
...
of time that the cross- bridges remain attached to the ac -
tin filaments, which is a major factor that determines the 
force of contraction, is believed to be greatly increased in 
smooth muscle. A possible reason for the slow cycling is 
that the cross- bridge heads have far less ATPase activ -
ity than in skeletal muscle; thus, degradation of the <span class="c-cyan">ATP</span> 
that energizes the movements of the cross- bridge heads 
is greatly reduced, with corresponding slowing of the rate 
of cycling. 
Low Energy Requirement to Sustain Smooth Mus -
cle Contraction. Only 1/10 to 1/300 as much energy is 
required to sustain the same tension of contraction in 
smooth muscle as in skeletal muscle. This, too, is believed 
to result from the slow attachment and detachment cy -
cling of the cross- bridges, and because only one molecule 
of <span class="c-cyan">ATP</span> is required for each cycle, regardless of its dura -
tion.
...
after it is <span class="c-green">excite</span>d, reaches full contraction about 0.5 sec -
ond later, and then declines in contractile force in another 
1 to 2 seconds, giving a total contraction time of 1 to 3 
seconds. This is about 30 times as long as a single contrac-
tion of an average skeletal muscle fiber. However, because 
...
has developed full contraction, the amount of continu -
ing excitation can usually be reduced to far less than the 
...
the smooth muscle in the bladder wall, causes an im -
mediate large increase in pressure in the bladder. How -
ever, during about the next 15 to 60 seconds, despite 
continued stretch of the bladder wall, the pressure re -
turns almost exactly back to the original level. Then, 
...
for short periods, they allow a hollow organ to main -
tain about the same amount of pressure inside its lumen 
...
ferent types of smooth muscle by nerve stimulation of  
the smooth muscle fiber, hormonal stimulation, stretch of the 
fiber, or even changes in the chemical environment of  
the fiber.
Smooth muscle does not contain troponin, the regu -
latory protein that is <span class="c-green">activate</span>d by calcium ions to cause 
skeletal muscle contraction. Instead, smooth muscle con-
traction is <span class="c-green">activate</span>d by an entirely different mechanism, 
as described in the next section.

UNIT II Membrane Physiology, Nerve, and Muscle
Calcium Ions Combine with Calmodulin to Cause Ac-
tivation of Myosin Kinase and Phosphorylation of 
...
of calcium from the extracellular fluid through cal -
cium channels and/or release of calcium from the 
...
and <span class="c-green">activates</span> myosin light chain kinase, a phospho-
rylating enzyme.
...
cycling of the myosin head with the <span class="c-pink">actin filament</span> 
does not occur. However, when the regulatory chain 
is phosphorylated, the head has the capability of 
binding repetitively with the <span class="c-pink">actin filament</span> and pro-
ceeding through the entire cycling process of inter-
mittent pulls, the same as what occurs for skeletal 
...
skeletal muscle, is <span class="c-green">activate</span>d by calcium ions, the source 
of the calcium ions differs. An important difference is 
that the <span class="c-yellow">sarcoplasmic reticulum</span>, which provides virtu -
ally all the calcium ions for skeletal muscle contraction, is 
...
<span class="c-yellow">action potential</span> or other stimulus. That is, the concentra-
...
for this diffusion to occur averages 200 to 300 millisec -
onds and is called the latent period  before contraction 
begins. This latent period is about 50 times as great for 
smooth muscle as for skeletal muscle contraction.
Role of the Smooth Muscle <span class="c-yellow">Sarcoplasmic Reticulum</span> . 
Figure 8-4 shows a few slightly developed sarcoplasmic 
tubules that lie near the cell membrane in some larger 
smooth muscle cells. Small invaginations of the cell mem-
brane, called caveolae, abut the surfaces of these tubules. 
...
PP
Extracellular fluid
Figure 8-3  Intracellular calcium ion (Ca 2+) concentration increases 
when Ca2+ enters the cell through calcium channels in the cell mem-
brane or is released from the <span class="c-yellow">sarcoplasmic reticulum</span>. The Ca2+ binds 
to calmodulin (CaM) to form a Ca 2+- CaM complex, which then acti-
vates myosin light chain kinase (MLCK). The active MLCK phospho -
rylates the myosin light chain, leading to attachment of the myosin 
head with the <span class="c-pink">actin filament</span> and contraction of the smooth muscle. 
ADP, Adenosine diphosphate; <span class="c-cyan">ATP</span>, <span class="c-cyan">adenosine triphosphate</span>; P, phos-
phate.
Caveolae
Sarcoplasmic
reticulum
...
to <span class="c-green">excite</span> calcium ion release from the abutting sarcoplas-
mic tubules in the same way that action potentials in skel-
etal muscle transverse tubules cause release of calcium 
...
contracts. 
Smooth Muscle Contraction Is Dependent on Extra -
cellular Calcium Ion Concentration . Whereas chang -
...
contraction usually ceases. Therefore, the force of con -
traction of smooth muscle is usually highly dependent on 
...
the intracellular fluids. This removal is achieved by a cal-
cium pump that pumps calcium ions out of the smooth 
muscle fiber back into the extracellular fluid, or into a 
<span class="c-yellow">sarcoplasmic reticulum</span>, if it is present ( Figure 8-5). This 
pump requires <span class="c-cyan">ATP</span> and is slow acting in comparison with 
the fast- acting <span class="c-yellow">sarcoplasmic reticulum</span> pump in skeletal 
muscle. Therefore, a single smooth muscle contraction of-
ten lasts for seconds rather than hundredths to tenths of a 
second, as occurs for skeletal muscle. 
Myosin Phosphatase Is Important in Cessation of Con-
traction. Relaxation of the smooth muscle occurs when 
the calcium channels close and the calcium pump trans -
ports calcium ions out of the cytosolic fluid of the cell. 
When the calcium ion concentration falls below a critical 
level, the aforementioned processes automatically reverse, 
except for the phosphorylation of the myosin head. Re -
versal of this situation requires another enzyme, myosin 
phosphatase (see Figure 8-5), located in the cytosol of the 
smooth muscle cell, which splits the phosphate from the 
regulatory light chain. Then the cycling stops, and contrac-
tion ceases. The time required for the relaxation of muscle 
contraction, therefore, is determined to a great extent by 
the amount of active myosin phosphatase in the cell. 
Possible Mechanism for Regulating the Latch Phe -
nomenon. Because of the importance of the latch phe -
nomenon in smooth muscle, and because this phenom -
enon allows for the long-  term maintenance of tone in 
...
enzymes are both strongly <span class="c-green">activate</span>d, the cycling frequency 
...
remain attached to the <span class="c-pink">actin filament</span> for a longer and lon-
ger proportion of the cycling period. Therefore, the num-
ber of heads attached to the <span class="c-pink">actin filament</span> at any given 
...
the muscle because <span class="c-cyan">ATP</span> is not degraded to ADP , except 
on the rare occasion when a head detaches. 
NERVOUS AND <span class="c-yellow">HORMONAL CONTROL</span> 
OF SMOOTH MUSCLE CONTRACTION
Although skeletal muscle fibers are <span class="c-green">stimulate</span>d exclusively 
by the nervous system, smooth muscle can be <span class="c-green">stimulate</span>d 
to contract by nervous signals, hormonal stimulation, 
stretch of the muscle, and several other ways. The prin -
cipal reason for the difference is that the smooth muscle 
Ca2+ Ca2+ Na+
Na+
<span class="c-cyan">ATP</span>
<span class="c-cyan">ATP</span> Ca2+ 
Ca2+ 
Ca2+
<span class="c-yellow">Sarcoplasmic reticulum</span>
CaM
...
ion (Ca 2+) concentration decreases below a critical level as Ca 2+ is 
pumped out of the cell or into the <span class="c-yellow">sarcoplasmic reticulum</span>. Ca 2+ is 
then released from calmodulin (CaM), and myosin phosphatase 
removes phosphate from the myosin light chain, causing detach -
ment of the myosin head from the <span class="c-pink">actin filament</span> and relaxation of 
the smooth muscle. ADP, Adenosine diphosphate; <span class="c-cyan">ATP</span>, adenosine 
triphosphate; Na+, sodium; P, phosphate.

UNIT II Membrane Physiology, Nerve, and Muscle
membrane contains many types of receptor proteins that 
can initiate the contractile process. Still other recep -
tor proteins <span class="c-green">inhibit</span> smooth muscle contraction, which 
is another difference from skeletal muscle. Therefore, in 
this section, we discuss nervous control of smooth mus -
cle contraction, followed by <span class="c-yellow">hormonal control</span> and other 
means of control.
NEUROMUSCULAR JUNCTIONS OF 
SMOOTH MUSCLE
Physiologic Anatomy of Smooth Muscle Neuromus -
cular Junctions. Neuromuscular junctions of the highly 
structured type found on skeletal muscle fibers do not oc-
cur in smooth muscle. Instead, the autonomic nerve fibers 
...
the nerve fibers often innervate only the outer layer. Mus-
cle excitation travels from this outer layer to the inner lay-
ers by <span class="c-yellow">action potential</span> conduction in the muscle mass or 
...
the <span class="c-pink">motor end plate</span> on skeletal muscle fibers. Instead, 
most of the fine terminal axons have multiple varicosi-
ties distributed along their axes. At these points, the 
...
similar to those in the skeletal muscle end plate that con-
tain transmitter substance. However, in contrast to the 
vesicles of skeletal muscle junctions, which always con -
tain <span class="c-cyan">acetylcholine</span>, the vesicles of the autonomic nerve 
fiber endings contain <span class="c-cyan">acetylcholine</span> in some fibers and 
<span class="c-cyan">norepinephrine</span> in others and occasionally other sub -
stances as well.
In a few cases, particularly in the multi-  unit type of 
smooth muscle, the varicosities are separated from the 
muscle cell membrane by as little as 20 to 30 nanome -
ters—the same width as the <span class="c-pink">synaptic cleft</span> that is found 
in the skeletal muscle junction. These are called contact 
junctions, and they function in much the same way as 
the skeletal muscle <span class="c-pink">neuromuscular junction</span>. The rapidity 
of contraction of these smooth muscle fibers is consid -
erably faster than that of fibers <span class="c-green">stimulate</span>d by the diffuse 
junctions. 
Excitatory and <span class="c-green">Inhibit</span>ory Transmitter Substances Se-
creted at the Smooth Muscle Neuromuscular Junc -
tion. The most important transmitter substances secret -
ed by the autonomic nerves innervating smooth muscle 
are <span class="c-cyan">acetylcholine</span> and <span class="c-cyan">norepinephrine</span>, but they are never 
secreted by the same nerve fibers. <span class="c-cyan">Acetylcholine</span> is an ex -
citatory transmitter substance for smooth muscle fibers 
in some organs but an <span class="c-green">inhibit</span>ory transmitter for smooth 
muscle in other organs. When <span class="c-cyan">acetylcholine</span> <span class="c-green">excites</span> a 
muscle fiber, <span class="c-cyan">norepinephrine</span> ordinarily <span class="c-green">inhibits</span> it. Con -
versely, when <span class="c-cyan">acetylcholine</span> <span class="c-green">inhibits</span> a fiber, norepineph -
rine usually <span class="c-green">excites</span> it.
Why are these responses different? The answer is that 
both <span class="c-cyan">acetylcholine</span> and <span class="c-cyan">norepinephrine</span> <span class="c-green">excite</span> or <span class="c-green">inhibit</span> 
...
are <span class="c-green">inhibit</span>ory receptors. Thus, the type of receptor deter -
mines whether the smooth muscle is <span class="c-green">inhibit</span>ed or <span class="c-green">excite</span>d 
and also determines which of the two transmitters, ace -
tylcholine or <span class="c-cyan">norepinephrine</span>, is effective in causing the 
excitation or <span class="c-green">inhibit</span>ion. These receptors are discussed 
...
tative voltage of the <span class="c-yellow">membrane potential</span> of smooth mus-
cle depends on the momentary condition of the muscle. 
In the normal resting state, the intracellular potential is 
usually about −50 to −60 millivolts, which is about 30 mil-
livolts less negative than in skeletal muscle. 
Visceral
Autonomic neuron
varicosity
Neurotransmitter
...
Autonomic neuron
varicosity
Figure 8-6 Innervation of smooth muscle by autonomic nerve fib -
ers that branch diffusely and secrete neurotransmitter from multiple 
varicosities. Unitary (visceral) smooth muscle cells are connected by 
gap junctions so that <span class="c-yellow">depolarization</span> can rapidly spread from one cell 
to another, permitting the muscle cells to contract as a single unit. In 
multi- unit smooth muscle, each cell is <span class="c-green">stimulate</span>d independently by a 
...
muscle) in the same way that they occur in skeletal mus -
cle. They do not normally occur in most multi-  unit types 
...
unitary smooth muscle. The duration of this type of ac -
tion potential is 10 to 50 milliseconds, as shown in Fig-
ure 8-7A. Such action potentials can be elicited in many 
ways—for example, by electrical stimulation, by the ac -
tion of hormones on the smooth muscle, by the action of 
...
smooth muscle <span class="c-yellow">action potential</span> with a plateau. The onset 
of this <span class="c-yellow">action potential</span> is similar to that of the typical spike 
potential. However, instead of rapid <span class="c-yellow">repolarization</span> of the 
muscle fiber membrane, the <span class="c-yellow">repolarization</span> is delayed for 
several hundred to as much as 1000 milliseconds (1 sec -
ond). The importance of the plateau is that it can account 
...
muscle. Also, this is the type of <span class="c-yellow">action potential</span> seen in 
cardiac muscle fibers that have a prolonged period of con-
traction, as discussed in Chapters 9 and 10. 
Calcium Channels Are Important in Generating the 
Smooth Muscle <span class="c-yellow">Action Potential</span> . The smooth muscle 
cell membrane has far more voltage- gated calcium chan-
nels than skeletal muscle but few voltage- gated sodium 
channels. Therefore, sodium does not participate much 
in the generation of the <span class="c-yellow">action potential</span> in most smooth 
muscle. Instead, the flow of calcium ions to the interior 
of the fiber is mainly responsible for the <span class="c-yellow">action potential</span>. 
This flow occurs in the same self- regenerative way as oc-
curs for the sodium channels in nerve fibers and in skel -
etal muscle fibers. However, the calcium channels open 
many times more slowly than sodium channels, and they 
also remain open much longer. These characteristics 
largely account for the prolonged plateau action poten -
tials of some smooth muscle fibers.
Another important feature of calcium ion entry into 
the cells during the <span class="c-yellow">action potential</span> is that the calcium 
ions act directly on the smooth muscle contractile mech-
anism to cause contraction. Thus, the calcium performs 
two tasks at once. 
Slow Wave Potentials in Unitary Smooth Muscle Can 
Lead to Spontaneous Generation of Action Poten -
tials. Some smooth muscle is self- excitatory—that is, ac-
tion potentials arise within the smooth muscle cells with-
out an extrinsic stimulus. This activity is often associated 
with a basic slow wave rhythm of the <span class="c-yellow">membrane potential</span>. 
...
brane. That is, the <span class="c-yellow">membrane potential</span> becomes more 
...
ceral smooth muscle), an <span class="c-yellow">action potential</span> develops and 
spreads over the muscle mass and contraction occurs. 
Figure 8-7 B demonstrates this effect, showing that at 
Milliseconds
MillivoltsMillivolts
A
C
B
50 100
...
Seconds
0 0.1 0.2 0.3 0.4
Figure 8-7 A, Typical smooth muscle <span class="c-yellow">action potential</span> (spike poten -
tial) elicited by an external stimulus. B, Repetitive spike potentials, 
elicited by slow rhythmical electrical waves that occur spontaneously 
in the smooth muscle of the intestinal wall. C, <span class="c-yellow">Action potential</span> with a 
...
decrease in overall negativity of the <span class="c-yellow">membrane potential</span> 
caused by the stretch. This response to stretch allows the 
gut wall, when excessively stretched, to contract auto -
matically and rhythmically. For example, when the gut is 
overfilled by intestinal contents, local automatic contrac-
tions often set up peristaltic waves that move the contents 
away from the overfilled intestine, usually in the direction 
of the anus. 
<span class="c-yellow">DEPOLARIZATION</span> OF MULTI- UNIT SMOOTH 
...
to nerve stimuli. The nerve endings secrete <span class="c-cyan">acetylcholine</span> in 
the case of some multi-  unit smooth muscles and norepi-
nephrine in the case of others. In both cases, the transmit-
ter substances cause <span class="c-yellow">depolarization</span> of the smooth muscle 
membrane, and this <span class="c-yellow">depolarization</span> in turn elicits contrac-
tion. Action potentials usually do not develop because the 
fibers are too small to generate an <span class="c-yellow">action potential</span>. (When 
action potentials are elicited in visceral unitary smooth 
muscle, 30 to 40 smooth muscle fibers must depolarize 
simultaneously before a self-  propagating <span class="c-yellow">action potential</span> 
ensues.) However, in small smooth muscle cells, even with-
out an <span class="c-yellow">action potential</span>, the local <span class="c-yellow">depolarization</span> (called the 
junctional potential) caused by the nerve transmitter sub-
stance spreads “electrotonically” over the entire fiber and is 
...
action potentials. Two types of non- nervous and nonac -
tion potential stimulating factors often involved are (1) 
local tissue chemical factors and (2) various hormones.
Smooth Muscle Contraction in Response to Local Tis-
sue Chemical Factors. In Chapter 17, we discuss control 
of contraction of the arterioles, meta- arterioles, and pre-
<span class="c-pink">capillary</span> sphincters. The smallest of these vessels have lit-
tle or no nervous supply. Yet, the smooth muscle is highly 
contractile, responding rapidly to changes in local chemi-
cal conditions in the surrounding interstitial fluid and to 
...
muscle relaxation and, therefore, <span class="c-green">vasodilation</span>.
 2.  Excess carbon dioxide causes <span class="c-green">vasodilation</span>.
...
local <span class="c-green">vasodilation</span>. Decreased blood pressure, by caus -
ing decreased stretch of the vascular smooth muscle, also 
...
muscle contraction to some degree, and some have pro -
found effects. Among the more important of these hor -
mones are <span class="c-cyan">norepinephrine</span>, <span class="c-cyan">epinephrine</span>, <span class="c-cyan">angiotensin II</span>, en-
dothelin, <span class="c-cyan">vasopressin</span>, oxytocin, <span class="c-cyan">serotonin</span>, and histamine.
A hormone causes contraction of a smooth muscle 
when the muscle cell membrane contains hormone- gated 
excitatory receptors  for the respective hormone. Con -
versely, the hormone causes <span class="c-green">inhibit</span>ion if the membrane 
contains <span class="c-green">inhibit</span>ory receptors for the hormone rather than 
excitatory receptors. 
Mechanisms of Smooth Muscle Excitation or Inhibi -
tion by Hormones or Local Tissue Factors . Some hor-
mone receptors in the smooth muscle membrane open 
sodium or calcium ion channels and depolarize the mem-
brane, the same as after nerve stimulation. Sometimes, 
action potentials result, or action potentials that are al -
ready occurring may be enhanced. In other cases, depo -
larization occurs without action potentials, and this depo-
larization allows for calcium ion entry into the cell, which 
promotes the contraction.
<span class="c-green">Inhibit</span>ion, in contrast, occurs when the hormone (or 
other tissue factor) closes the sodium and calcium chan -
nels to prevent entry of these positive ions; <span class="c-green">inhibit</span>ion 
also occurs if the normally closed potassium channels are 
opened, allowing positive potassium ions to diffuse out of 
the cell. Both these actions increase the degree of negativ-
ity inside the muscle cell, a state called hyperpolarization, 
which strongly <span class="c-green">inhibits</span> muscle contraction.
Sometimes, smooth muscle contraction or <span class="c-green">inhibit</span>ion is 
initiated by hormones without directly causing any change 
in the <span class="c-yellow">membrane potential</span>. In these cases, the hormone 
may <span class="c-green">activate</span> a membrane receptor that does not open 

UNIT II
any ion channels but, instead, causes an internal change 
in the muscle fiber, such as release of calcium ions from 
the intracellular <span class="c-yellow">sarcoplasmic reticulum</span>; the calcium then 
induces contraction. To <span class="c-green">inhibit</span> contraction, other recep -
tor mechanisms are known to <span class="c-green">activate</span> the enzyme ade -
nylate cyclase or guanylate cyclase in the cell membrane. 
The portions of the receptors that protrude to the interior 
of the cells are coupled to these enzymes, causing the for-
mation of cyclic adenosine monophosphate (cAMP) or 
cyclic guanosine monophosphate (cGMP), so- called sec-
ond messengers. cAMP or cGMP has many effects, one 
of which is to change the degree of phosphorylation of 
several enzymes that indirectly <span class="c-green">inhibit</span> contraction. The 
pump that moves calcium ions from the sarcoplasm into 
the <span class="c-yellow">sarcoplasmic reticulum</span> is <span class="c-green">activate</span>d, as well as the cell 
membrane pump that moves calcium ions out of the cell; 
these effects reduce the calcium ion concentration in the 
sarcoplasm, thereby <span class="c-green">inhibit</span>ing contraction.
...
stances. In some cases, the same substance may cause 
either relaxation or contraction of smooth muscles in 
different locations. For example, <span class="c-cyan">norepinephrine</span> <span class="c-green">inhibits</span> 
contraction of smooth muscle in the intestine but stimu -
lates contraction of smooth muscle in blood vessels.
Bibliography
Also see the bibliography for Chapters 5 and 6.
Behringer EJ, Segal SS: Spreading the signal for vasodilatation: im -
plications for skeletal muscle blood flow control and the effects of 
aging. J Physiol 590:6277, 2012.
Berridge MJ: Smooth muscle cell calcium activation mechanisms. J 
Physiol 586:5047, 2008.
...
gan KG: Mechanisms of vascular smooth muscle contraction and 
the basis for pharmacologic treatment of smooth muscle disorders. 
Pharmacol Rev 68:476, 2016.
Burnstock G. Purinergic signaling in the cardiovascular system. Circ 
Res 120:207, 2017.
Cheng H, Lederer WJ: Calcium sparks. Physiol Rev 88:1491, 2008.
Davis MJ: Perspective: physiological role(s) of the vascular myogenic 
response. Microcirculation 19:99, 2012.
Dopico AM, Bukiya AN, Jaggar JH. Calcium-  and voltage- gated BK 
channels in vascular smooth muscle. Pflugers Arch 470:1271, 
2018.
Dora KA. Endothelial- smooth muscle cell interactions in the regulation of 
vascular tone in skeletal muscle. Microcirculation 23:626, 2016.
...
Hill MA, Meininger GA. Small artery mechanobiology: roles of cellular 
and non- cellular elements. Microcirculation 23:611, 2016.
...
296:G1, 2009.
Kauffenstein G, Laher I, Matrougui K, et al: Emerging role of G 
protein- coupled receptors in microvascular myogenic tone. Cardio-
vasc Res 95:223, 2012.
...
Morgan KG, Gangopadhyay SS: Cross- bridge regulation by thin 
filament- associated proteins. J Appl Physiol 91:953, 2001.
Ratz PH. Mechanics of vascular smooth muscle. Compr Physiol 6:111, 
2015.
Sanders KM, Kito Y, Hwang SJ, Ward SM. Regulation of gastroin -
testinal smooth muscle function by interstitial cells. Physiology 
(Bethesda) 31:316, 2016.
Somlyo AP, Somlyo AV: Ca 2+ sensitivity of smooth muscle and non -
muscle myosin II: modulated by G proteins, kinases, and myosin 
phosphatase. Physiol Rev 83:1325, 2003.
Tykocki NR, Boerman EM, Jackson WF. Smooth muscle ion channels 
and regulation of vascular tone in resistance arteries and arterioles. 
Compr Physiol 7:485, 2017.
Webb RC: Smooth muscle contraction and relaxation. Adv Physiol 
Educ 27:201, 2003.
...
muscle—atrial muscle, ventricular muscle,  and special -
ized excitatory and conductive muscle  fibers. The atrial 
...
and conductive fibers of the heart, however, contract fee-
bly because they contain few contractile fibrils; instead, 
they exhibit automatic rhythmical electrical discharge in 
the form of action potentials or conduction of the action 
potentials through the heart, providing an excitatory sys -
tem that controls the rhythmical beating of the heart.
CARDIAC MUSCLE ANATOMY
Figure 9- 2 shows the cardiac muscle histology, demon -
strating cardiac muscle fibers arranged in a latticework, 
with the fibers dividing, recombining, and then spreading 
again. Note that cardiac muscle is striated in the same 
manner as in skeletal muscle. Furthermore, cardiac mus -
cle has typical myofibrils that contain actin and myosin 
filaments almost identical to those found in skeletal mus-
cle; these filaments lie side by side and slide during con -
traction in the same manner as occurs in skeletal muscle 
...
the cardiac muscle fibers in Figure 9- 2 are called interca-
lated discs; they are actually cell membranes that separate 
...
(gap junctions) that allow rapid diffusion of ions. There -
fore, from a functional point of view, ions move with ease 
...
from one cardiac muscle cell to the next, past the interca-
lated discs. Thus, cardiac muscle is a syncytium of many 
heart muscle cells in which the cardiac cells are so inter -
connected that when one cell becomes <span class="c-green">excite</span>d, the action 
...
atria and ventricles. Normally, potentials are not con -
ducted from the atrial syncytium into the ventricular 
syncytium directly through this fibrous tissue. Instead, 
they are only conducted by way of a specialized conduc -
tive system called the A- V bundle, a bundle of conductive 
...
MUSCLE
The <span class="c-yellow">action potential</span>  recorded in a ventricular muscle 
...
depolarized for about 0.2 second, exhibiting a plateau, fol-
lowed at the end of the plateau by abrupt <span class="c-yellow">repolarization</span>. 
Intercalated discs
Figure 9- 2. Syncytial interconnecting nature of cardiac muscle fibers.
Epicardial fibers Apex
AB
BaseEndocardial fibers
Figure 9- 3. A, The left ventricular inner subendocardial fibers (laven-
der shade) run obliquely to the outer subepicardial fibers (red shade). 
...
layers, including the inner endocardium, myocardium, and more out-
ward epicardium and pericardium layers.