...
book: "Guyton & Hall"
summary: "Chapter 31 from Guyton & Hall Textbook of Medical Physiology, 14th Edition. Content extracted from official PDF source."
key_points:
...
## Bicarbonate Buffer System（碳酸氫鹽緩衝系統）
...
其中 pK = 6.1，0.03 是 CO₂ 的溶解係數。從這個方程式可見，血漿 pH 由 [HCO₃⁻] 與 PCO₂ 的比例決定。
...
磷酸鹽緩衝系統由 H₂PO₄⁻（酸性形式）與 HPO₄²⁻（鹼性形式）組成，pK = 6.8，接近生理 pH，使其在細胞內與腎小管液中具有較佳的緩衝能力。

磷酸鹽緩衝系統在腎小管液中特別重要，因為：

- 磷酸鹽在腎小管中被濃縮，緩衝容量增加
- 腎小管液的 pH 通常低於細胞外液，更接近磷酸鹽的 pK

## 蛋白質緩衝系統

蛋白質是細胞內最多的緩衝物質。血紅蛋白（hemoglobin）是紅血球中重要的緩衝劑：

H⁺ + Hb ⇌ HHb

當血液進入組織毛細血管，二氧化碳擴散入紅血球形成 H₂CO₃ → H⁺ + HCO₃⁻，H⁺ 被血紅蛋白結合，HCO₃⁻ 被移出紅血球進入血漿置換 Cl⁻（chloride shift）。這個機制使血液能有效運輸二氧化碳而不大幅改變血漿 pH。

## 腎臟在酸鹼平衡中的角色

腎臟調控酸鹼平衡的核心是兩件事：

1. **再吸收幾乎所有濾過的 HCO₃⁻**（每天約 4320 mEq）
2. **排泄每天產生的非揮發性酸**（每天約 80 mEq）

### 碳酸氫根的再吸收

濾過的 HCO₃⁻ 不能直接被再吸收——它必須先與腎小管分泌的 H⁺ 結合成 H₂CO₃ → CO₂ + H₂O，CO₂ 擴散進入細胞後，在碳酸酐酶幫助下重新形成 H₂CO₃ → H⁺ + HCO₃⁻，最後 HCO₃⁻ 離開細胞回到血液。這個過程在每個腎元都會發生，最終使幾乎所有濾過的 HCO₃⁻ 都回到血液。

### 新碳酸氫根的生成

在酸中毒時，腎小管細胞會生成新的 HCO₃⁻ 並將其釋放到血液中（不是簡單地再吸收原本濾過的 HCO₃⁻）。這個新生成的 HCO₃⁻ 來自細胞內的 CO₂ 與水。分泌的 H⁺ 並非與濾過的 HCO₃⁻ 反應，而是與管腔中的緩衝物質（如 HPO₄²⁻、肌酸酐）反應後被排泄。

### H⁺ 分泌的機制

- **Proximal tubule**：Na⁺-H⁺ exchanger（次級主動運輸），受細胞內 Na⁺ 梯度驅動
- **Intercalated cells（集合管）**：H⁺-ATPase（主動運輸），可在分泌 H⁺ 的同時產生極端的 H⁺ 梯度（可達 1000 倍）
